...
const Education = () => {
  return (
    <section className="my-4 sm:my-10 px-4 md:px-12">
      <h2 className="text-3xl md:text-4xl font-bold text-center text-blue-600 mb-6 sm:mb-10 animate-fade-in">Education</h2>
      <div className="space-y-6">
        ...
        {/* Higher Secondary */}
        <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-2xl shadow-md hover:shadow-xl hover:scale-105 transition duration-300 ease-in-out cursor-pointer">
