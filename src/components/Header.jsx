  ...
  return (
    <header className='fixed top-0 left-0 w-full z-50 bg-gray-800 shadow-lg/30 text-gray-300'>
      <div className='flex items-center justify-between px-4 py-4 sm:px-6 md:px-8'>
        {/* Logo */}
        <Link to='home' offset={-80} smooth duration={500} className='text-md sm:text-xl text-shadow-lg/50 font-bold hover:scale-105 transition duration-200'>
          dipankar049
        </Link>
        ...
        <nav className='hidden sm:flex space-x-4 md:space-x-6 text-sm sm:text-lg font-semibold'>
          <Link to='home' offset={-80} smooth duration={500} className={LinkClass}>Home</Link>
          <Link to='about' offset={-80} smooth duration={500} className={LinkClass}>About</Link>
          <Link to='skills' offset={-80} smooth duration={500} className={LinkClass}>Skills</Link>
          <Link to='projects' offset={-80} smooth duration={500} className={LinkClass}>Projects</Link>
          <Link to='experience' offset={-80} smooth duration={500} className={LinkClass}>Experience</Link>
          <Link to='education' offset={-80} smooth duration={500} className={LinkClass}>Education</Link>
        </nav>
      </div>
